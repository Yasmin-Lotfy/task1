...
export default function SideBar() {
  ...
  return (
    <div className=" hidden text-[10px] md:text-[12px] lg:text-[16px] sm:block w-[30%]  font-main-font bg-hero-pattern bg-cover bg-center rounded-2xl pt-6 h-screen text-white">
